...
from nn import _Hswish, _ConvBNHswish, Bottleneck,SEModule
    ...
    def __init__(self, nclass=1000, mode='large', width_mult=1.0, dilated=False, norm_layer=nn.BatchNorm2d):
        ...
        if dilated:
            self.layer4 = self._make_layer(Bottleneck, layer4_setting,
                                           width_mult, dilation=1, norm_layer=norm_layer)
        else:
            self.layer4 = self._make_layer(Bottleneck, layer4_setting,
                                           width_mult, norm_layer=norm_layer)
        ...
        if mode == 'large':
            ...
            self.layer5 = _ConvBNHswish(self.in_channels, last_bneck_channels, 2, norm_layer=norm_layer)
            ...
            self.layer5 = _ConvBNHswish(self.in_channels, last_bneck_channels, 1, 2,norm_layer=norm_layer)
