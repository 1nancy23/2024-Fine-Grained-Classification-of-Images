...
class CSPDarkNet53(nn.Module):
    ...
    def forward(self, x):
        ...
        x2 = torch.einsum('ij,ijkl->ijkl', self.Att(self.classifier1(Features[1]),self.classifier2(Features[0]),self.classifier3(Features[2])), Features[2])
        return self.Conv1(x2)
